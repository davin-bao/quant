    ...
    async safety() {
        ...
        if (aSellVolume > volume_limit && bBuyVolume > volume_limit) {
            ...
            // if (aSlaveBalance / aSellPrice > volume && bMasterBalance > volume) {
                ...
                // Log.Info(__filename, 'market:'+this.market+' bBuy:'+bBuyPrice+' aSell:'+aSellPrice+' a:' + ((bBuyPrice - aSellPrice - aSellFee - bBuyFee) / ((aSellPrice + bBuyPrice) / 2)));
        ...
        if (aBuyVolume > volume_limit && bSellVolume > volume_limit) {
            ...
            // if (aMasterBalance > volume && bSlaveBalance / bSellPrice > volume) {
                ...
                // Log.Info(__filename, 'market:'+this.market+' aBuy:'+aBuyPrice+' bSell:'+bSellPrice+' b:' + ((aBuyPrice - bSellPrice - aBuyFee - bSellFee) / ((aBuyPrice + bSellPrice) / 2)));
